...
public class JsFunction extends JavaScriptObject {
  ...
  private final static native JsFunction createEventListener(String callbackId) /*-{
    ...
    return function(event) {
      @com.harmonia.js.JsFunctionCallbacks::invoke(Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(callbackId, event)
    }
  }-*/;
  ...
  private final static native JsFunction create(String callbackId, boolean once) /*-{
    ...
    this.once = once
    return function() {
      @com.harmonia.js.JsFunctionCallbacks::invoke(Ljava/lang/String;)(callbackId)
      if (once) {
        @com.harmonia.js.JsFunctionCallbacks::remove(Ljava/lang/String;)(callbackId)
      }
    }
  }-*/;
  
  private final static native void removeCallback() /*-{
    @com.harmonia.js.JsFunctionCallbacks::remove(Ljava/lang/String;)(this.callbackId)
  }-*/;
}
